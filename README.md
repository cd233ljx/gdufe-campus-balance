...
前往 [Releases](https://github.com/cd233ljx/gdufe-campus-balance/releases/latest)，下载 `gdufe-campus-balance-v0.1.3-windows-x64.zip`，**完整解压**后双击 `gdufe-campus-balance.exe`。不要单独移动 EXE，旁边的 `_internal` 是运行必需文件。

1. 首次打开会询问是否开机自启，选择后可在「设置」中随时开关。选择需要关注的项目，点击「登录学校账号」，在独立的 Edge / Chrome 窗口完成学校认证。
